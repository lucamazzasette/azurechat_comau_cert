...
export const ChatPage: FC<ChatPageProps> = (props) => {
  ...
  useEffect(() => {
    if (props.initialMessage && formRef.current) {
      ...
      // This helps prevent multiple loading states before seeing the user message
      setTimeout(() => {
        if (formRef.current) {
          // Will trigger the form submission with the decoded message
          formRef.current.requestSubmit();
        }
      }, 100); // Reduced from 300ms to make it more responsive
    }
      ...
      <AnimatePresence mode="wait">
          <motion.div
            ...
            style={{ 
              ...
              maxHeight: 'calc(100vh - 260px)' // Ensure consistent max height
            }}
          >
